...
export function buildApplicationSubmittedEmail({
  ...
  programmeName,
  submittedAt,
}: ApplicationSubmittedEmailInput): ApplicationEmailTemplate {
          ...
          <tr>
            <td style="padding:32px 24px;">
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:${BRAND.canvas};border-radius:8px;margin:20px 0;">
                ...
                <tr>
                  <td style="padding:16px;border-top:1px solid ${BRAND.border};">
                    <p style="margin:0;font-size:14px;color:${BRAND.textMuted};">Submitted On</p>
                    <p style="margin:4px 0 0;font-size:16px;color:${BRAND.text};">${escapeHtml(submittedAt)}</p>
                  </td>
                </tr>
              </table>
